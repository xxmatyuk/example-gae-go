...
var (
	...
	// DB Mocks
	okDBPut = func(key string, entity *Entity) error {
		return nil
	}
	errDBPut = func(key string, entity *Entity) error {
		return errors.New("fail")
	}
	okDBGet = func(key string) (*Entity, error) {
		return &testEntity, nil
	}
	errDDGet = func(key string) (*Entity, error) {
		return nil, errors.New("fail")
	}
	missDBGet = func(key string) (*Entity, error) {
		return nil, datastore.ErrNoSuchEntity
	}
	okDBGetAll = func() (*[]Entity, error) {
		return &[]Entity{testEntity}, nil
	}
	errDBGetAll = func() (*[]Entity, error) {
		return nil, errors.New("fail")
	}

	// Cache mocks
	okCacheGet = func(key string) (*Entity, error) {
		return &testEntity, nil
	}
	errCacheGet = func(key string) (*Entity, error) {
		return nil, errors.New("fail")
	}
	missCacheGet = func(key string) (*Entity, error) {
		return nil, nil
	}
	okCachePut = func(entity *Entity) error {
		return nil
	}
)
...
func TestGetEntities(t *testing.T) {
	...
	for _, test := range testsGetEntity {
		t.Run(test.name, func(t *testing.T) {
			...
			performGetEntityRequest(rr, req, s)
...
func performGetEntityRequest(rr *httptest.ResponseRecorder, req *http.Request, s *Service) {
